        ...
        <div className='bg-[#F6F8FB]'>
            <div className="flex flex-col md:flex-row items-center py-15 lg:px-25 px-6 container mx-auto">
                <div className="md:w-6/12 flex flex-col gap-3">
                    ...
                    <p className='dm-sans-font lg:text-[18px] md:text-[14px] text-[14px] leading-[30px] max-w-lg'>We help build and manage a team of world-class developers to bring your vision to life</p>
